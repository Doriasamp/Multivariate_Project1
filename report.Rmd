...
#get standardized (scaled) data matrix
...
```
#### Answers and comments:
We expect to see that the covariance matrix of the standardized data matrix is the same as the correlation matrix (R) of the standardized data. This is exactly the case, as shown above, as the S.std and R matrices are equivalent.
