...
```
#### Answers and comments:
We expect to see that the covariance matrix of the standardized data matrix is the same as its correlation matrix (R). This is exactly the case, as shown above, as the S.std and R matrices are equivalent.
